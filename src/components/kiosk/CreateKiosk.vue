<template>
              ...
              <div>
                <div>
                  <div class="con-exemple-prompt px-4 py-3">
                    ...
                    <vs-select class="w-100 mb-2 mt-2" :label="$t('Kiosk.AddKioskPrompt.Theme')" v-model="promptData.theme">
                      <vs-select-item
                              :key="index"
                              :value="item.value"
                              :text="item.text"
                    ...
                    <vs-row class="ml-2">
                      <label class="vs-input--label w-25 mb-2 mt-2" for="color-add-edit">{{$t('Kiosk.AddKioskPrompt.Colors.Primary')}}</label>
                      <vs-checkbox class="w-25 mb-2 mt-2" v-model="defaultPrimary">{{$t('Kiosk.AddKioskPrompt.Colors.Default')}}</vs-checkbox>
                      <input v-if="!defaultPrimary" v-model="promptData.primary" type="color" name="" value="" class="w-25 mb-2 mt-2"/>
                    </vs-row>

                    <vs-row class="ml-2">
                      <label class="vs-input--label mt-2 mb-2 w-25" for="color-add-edit">{{$t('Kiosk.AddKioskPrompt.Colors.Secondary')}}</label>
                      <vs-checkbox class="w-25 mb-2 mt-2" v-model="defaultSecondary">{{$t('Kiosk.AddKioskPrompt.Colors.Default')}}</vs-checkbox>
                      <input v-if="!defaultSecondary" v-model="promptData.secondary" type="color" name="" value="" class="w-25 mb-2 mt-2"/>
                    </vs-row> 

                    <vs-row class="ml-2">
                      <label class="vs-input--label mt-2 mb-2 w-25" for="color-add-edit">{{$t('Kiosk.AddKioskPrompt.Colors.Success')}}</label>
                      <vs-checkbox class="w-25 mb-2 mt-2" v-model="defaultSuccess">{{$t('Kiosk.AddKioskPrompt.Colors.Default')}}</vs-checkbox>
                      <input v-if="!defaultSuccess" v-model="promptData.success" type="color" name="" value="" class="w-25 mb-2 mt-2"/>
                    </vs-row>

                    <vs-row class="ml-2">
                      <label class="vs-input--label mt-2 w-25" for="color-add-edit">{{$t('Kiosk.AddKioskPrompt.Colors.Danger')}}</label>
                      <vs-checkbox class="w-25 mt-2" v-model="defaultDanger">{{$t('Kiosk.AddKioskPrompt.Colors.Default')}}</vs-checkbox>
                      <input v-if="!defaultDanger" v-model="promptData.danger" type="color" name="" value="" class="w-25 mt-2"/>
                    </vs-row>
          ...
          <vs-button @click="acceptAlert()" :disabled="false" color="primary" class="pr-5 pl-5 float-right"> {{$t('Components.Queue.AddCustomerPrompt.PushButton')}} </vs-button>
        </vs-col>
         <vs-prompt
                    color="success"
