<template>
  <div class="text-center">
    <form-wizard @on-complete="onComplete" color="rgba(var(--vs-primary), 1)">
      <h3 slot="title" class="mb-3">This will replace my whole title</h3>
      <h6 slot="title" class="text-muted font-weight-normal">Custom Title Slot</h6>
