      ...
      <vs-row>
        ...
        /////////////////
          ...
          <vs-card>
            <h3 class="card-title d-flex">
              Line Chart
              <vs-button class="ml-auto p-0" @click="linechart=true" type="line">
            ...
            <!-- Code -->
            <vs-popup class="holamundo" title="Code" :active.sync="linechart">
              <vs-prism>
                &lt;template&gt;
                ...
                data() {
                return {
                themeColors: ['#2962FF', '#4fc3f7', '#f62d51', '#ffbc34', '#212529']
                lineChartSimple: {
                series: [{
                name: &quot;Desktops&quot;,
        ...
        /////////////////
          ...
          <vs-card>
            <h3 class="card-title d-flex">
              Column Chart
              <vs-button class="ml-auto p-0" @click="columnchart=true" type="line">
                <vs-icon icon="code"></vs-icon>
              </vs-button>
            </h3>
            <div>
            ...
            <!-- Code -->
            <vs-popup class="holamundo" title="Code" :active.sync="columnchart">
              <vs-prism>
                &lt;template&gt;
        ...
        /////////////////
          ...
          <vs-card>
            <h3 class="card-title d-flex">
              Line Area Chart
              <vs-button class="ml-auto p-0" @click="lineareachart=true" type="line">
                <vs-icon icon="code"></vs-icon>
              </vs-button>
            </h3>
            <div>
            ...
            <!-- Code -->
            <vs-popup class="holamundo" title="Code" :active.sync="lineareachart">
              <vs-prism>
                &lt;template&gt;
        ...
        /////////////////
          ...
          <vs-card>
            <h3 class="card-title d-flex">
              Bar Chart
              <vs-button class="ml-auto p-0" @click="barchart=true" type="line">
                <vs-icon icon="code"></vs-icon>
              </vs-button>
            </h3>
            <div>
            ...
            <!-- Code -->
            <vs-popup class="holamundo" title="Code" :active.sync="barchart">
              <vs-prism>
                &lt;template&gt;
        ...
        /////////////////
          ...
          <vs-card>
            <h3 class="card-title d-flex">
              Candlestick Chart
              <vs-button class="ml-auto p-0" @click="caldlechart=true" type="line">
                <vs-icon icon="code"></vs-icon>
              </vs-button>
            </h3>
            <div>
            ...
            <!-- Code -->
            <vs-popup class="holamundo" title="Code" :active.sync="caldlechart">
              <vs-prism>
                &lt;template&gt;
        ...
        /////////////////
          ...
          <vs-card>
            <h3 class="card-title d-flex">
              Mixed Chart
              <vs-button class="ml-auto p-0" @click="mixedchart=true" type="line">
                <vs-icon icon="code"></vs-icon>
              </vs-button>
            </h3>
            <div>
            ...
            <!-- Code -->
            <vs-popup class="holamundo" title="Code" :active.sync="mixedchart">
              <vs-prism>
                &lt;template&gt;
        ...
        /////////////////
          ...
          <vs-card>
            <h3 class="card-title d-flex">
              3D Bubble Chart
              <vs-button class="ml-auto p-0" @click="threedchart=true" type="line">
                <vs-icon icon="code"></vs-icon>
              </vs-button>
            </h3>
            <div>
            ...
            <!-- Code -->
            <vs-popup class="holamundo" title="Code" :active.sync="threedchart">
              <vs-prism>
                &lt;template&gt;
        ...
        /////////////////
          ...
          <vs-card>
            <h3 class="card-title d-flex">
              Scatter Chart
              <vs-button class="ml-auto p-0" @click="scatterchart=true" type="line">
                <vs-icon icon="code"></vs-icon>
              </vs-button>
            </h3>
            <div>
            ...
            <!-- Code -->
            <vs-popup class="holamundo" title="Code" :active.sync="scatterchart">
              <vs-prism>
                &lt;template&gt;
        ...
        /////////////////
          ...
          <vs-card>
            <h3 class="card-title d-flex">
              Heat Map Chart
              <vs-button class="ml-auto p-0" @click="heatchart=true" type="line">
                <vs-icon icon="code"></vs-icon>
              </vs-button>
            </h3>
            <div>
            ...
            <!-- Code -->
            <vs-popup class="holamundo" title="Code" :active.sync="heatchart">
              <vs-prism>
                &lt;template&gt;
        ...
        /////////////////
          ...
          <vs-card>
            <h3 class="card-title d-flex">
              Donut Chart
              <vs-button class="ml-auto p-0" @click="doughnutchart=true" type="line">
                <vs-icon icon="code"></vs-icon>
              </vs-button>
            </h3>
            <div>
            ...
            <!-- Code -->
            <vs-popup class="holamundo" title="Code" :active.sync="doughnutchart">
              <vs-prism>
                &lt;template&gt;
        ...
        /////////////////
          ...
          <vs-card>
            <h3 class="card-title d-flex">
              Pie Chart
              <vs-button class="ml-auto p-0" @click="piechart=true" type="line">
                <vs-icon icon="code"></vs-icon>
              </vs-button>
            </h3>
            <div>
            ...
            <!-- Code -->
            <vs-popup class="holamundo" title="Code" :active.sync="piechart">
              <vs-prism>
                &lt;template&gt;
        ...
        /////////////////
          ...
          <vs-card>
            <h3 class="card-title d-flex">
              Radial Bar Chart
              <vs-button class="ml-auto p-0" @click="radialchart=true" type="line">
                <vs-icon icon="code"></vs-icon>
              </vs-button>
            </h3>
            <div>
            ...
            <!-- Code -->
            <vs-popup class="holamundo" title="Code" :active.sync="radialchart">
              <vs-prism>
                &lt;template&gt;
        ...
        /////////////////
          ...
          <vs-card>
            <h3 class="card-title d-flex">
              Radar Chart
              <vs-button class="ml-auto p-0" @click="radarchart=true" type="line">
                <vs-icon icon="code"></vs-icon>
              </vs-button>
            </h3>
            <div>
            ...
            <!-- Code -->
            <vs-popup class="holamundo" title="Code" :active.sync="radarchart">
              <vs-prism>
                &lt;template&gt;
