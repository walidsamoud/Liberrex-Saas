    ...
    <vs-card>
      ...
      <vs-row vs-justify="center" class="mt-5">
        <vs-col type="flex" vs-justify="center" vs-align="center" vs-lg="3" vs-xs="12">
          ...
          <draggable :list="todos" group="custom" class="p-2 cursor-move todo-cards">
              ...
              <div class="d-flex align-items-center mb-3">
                ...
                <div class="ml-auto">
                  <span
                    ...
                    :class="[{'display-none' : todolist.badgeactive}, {'active': isActive === index} ]"
                    :key="index"
                  >
        ...
        <vs-col type="flex" vs-justify="center" vs-align="center" vs-lg="3" vs-xs="12">
          ...
          <draggable :list="progresstodo" group="custom" class="p-2 cursor-move progress-cards">
        ...
        <vs-col type="flex" vs-justify="center" vs-align="center" vs-lg="3" vs-xs="12">
          ...
          <draggable :list="completetodo" group="custom" class="p-2 cursor-move completed-cards">
        ...
        <vs-col type="flex" vs-justify="center" vs-align="center" vs-lg="3" vs-xs="12">
          ...
          <draggable :list="onholdtodo" group="custom" class="p-2 cursor-move hold-cards">
      ...
      >
        ...
        <div class="mt-4 px-3">
          <form>
            ...
            <vs-button color="primary" type="filled" class="w-100 mt-4" @click="addTodo(index)">
