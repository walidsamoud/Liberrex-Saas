...
function getForService(services) {
    const requestOptions = {
        method: 'POST',
        headers: { ...authHeader(), 'Content-Type': 'application/json' },
        body: JSON.stringify(services)
    };
    return fetch(`${ApiConfigs.base_url+ApiConfigs.queues.getForService}`, requestOptions).then(handleResponse);
}
...
function fixDamagedTickets(data) {
    const requestOptions = {
        method: 'POST',
        headers: { ...authHeader(), 'Content-Type': 'application/json' },
        body: JSON.stringify(data)
    };
    return fetch(`${ApiConfigs.base_url+ApiConfigs.queues.fixDamagedTickets.replace(':id', data.id)}`, requestOptions).then(handleResponse);
}

function fixAllDamagedTickets(data) {
    const requestOptions = {
        method: 'POST',
        headers: { ...authHeader(), 'Content-Type': 'application/json' },
        body: JSON.stringify(data)
    };
    return fetch(`${ApiConfigs.base_url+ApiConfigs.queues.fixAllDamagedTickets}`, requestOptions).then(handleResponse);
}

function getDamagedtickets(data) {
    const requestOptions = {
        method: 'POST',
        headers: { ...authHeader(), 'Content-Type': 'application/json' },
        body: JSON.stringify(data)
    };
    return fetch(`${ApiConfigs.base_url+ApiConfigs.queues.getDamagedtickets}`, requestOptions).then(handleResponse);
}
